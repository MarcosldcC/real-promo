      ...
      <div className="container mx-auto grid gap-10 px-4 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/80">
            ...
            <li>
              <a className="hover:underline underline-offset-4" href="#services">
                Serviços
              </a>
            </li>
            <li>
              <a className="hover:underline underline-offset-4" href="#portfolio">
                Portfólio
              </a>
            </li>
            <li>
              <a className="hover:underline underline-offset-4" href="#specifications">
                Especificações
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/80">
            ...
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4" /> contato@realpromo.com.br
            </li>
            <li className="flex items-center gap-2">
              <MapPin className="h-4 w-4" /> Endereço: a definir
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="mt-3 flex gap-3">
            <a
              href="#"
              aria-label="Facebook"
              className="rounded-md border border-[var(--rp-gray)] p-2 hover:-translate-y-1 transition-transform"
            >
