...
const ALL: Item[] = [
  ...
  },
  {
    ...
    meta: "Cliente A • P2.5 Indoor",
  },
  {
    id: 5,
    category: "Eventos",
    src: "/placeholder.svg?height=950&width=700",
    title: "Summit Varejo",
    meta: "Cliente B • P3.91 Outdoor",
  },
  {
    id: 6,
    category: "Feiras",
    src: "/placeholder.svg?height=1000&width=760",
    title: "Expo Negócios",
    meta: "Cliente C • P2.5",
  },
  { id: 7, category: "Shows", src: "/placeholder.svg?height=980&width=780", title: "Open Air", meta: "Cliente D • P6" },
  {
    id: 8,
    category: "Corporativo",
    src: "/placeholder.svg?height=1020&width=720",
    title: "Kickoff",
    meta: "Cliente E • P2.5",
  },
]
...
export default function Portfolio() {
  ...
  return (
    <div className="container mx-auto px-4 py-20 md:py-28">
      ...
      {/* Masonry using CSS columns for a simple masonry effect */}
      <div className="mx-auto max-w-6xl [column-fill:_balance] columns-1 gap-4 sm:columns-2 lg:columns-3">
